...
import { StarRatingDisplay, Loading, PageWithSidebar } from '@/components/common';
      ...
      {isLoading ? (
        ...
        <>
          <div className="mb-4 text-gray-600">
            Mostrando {filteredRealEstates.length}{' '}
            {filteredRealEstates.length === 1 ? 'inmobiliaria' : 'inmobiliarias'}
          </div>
