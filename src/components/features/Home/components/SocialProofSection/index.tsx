        ...
        >
          {stats.map((stat) => (
            ...
            >
              ...
              <span className={`${playfair.className} text-2xl font-bold text-reviuy-gray-900 dark:text-white md:text-3xl`}>
                {stat.value}
              </span>
              <span className={`${manrope.className} mt-1 text-center text-sm text-reviuy-gray-500 dark:text-reviuy-gray-400`}>
                {stat.label}
              </span>
            </motion.div>
          ))}
