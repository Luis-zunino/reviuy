      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            ...
            <p
              className={`${manrope.className} mt-3 text-reviuy-gray-600 dark:text-reviuy-gray-400`}
            >
            ...
            >
              <div className="grid gap-6 md:grid-cols-2 md:gap-8">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p
                    className={`${manrope.className} mt-4 text-base leading-relaxed text-reviuy-gray-600 dark:text-reviuy-gray-400`}
                  >
