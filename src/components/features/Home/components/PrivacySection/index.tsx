          ...
          <div className="grid gap-8 p-8 md:grid-cols-2 md:gap-12 md:p-12 lg:p-16">
            ...
            <div className="flex flex-col justify-center">
              ...
              >
                ...
                <h2
                  className={`${playfair.className} mb-4 text-3xl font-bold text-reviuy-gray-900 dark:text-white md:text-4xl`}
                >
                  Tu privacidad es nuestra prioridad
                </h2>

                <p
                  className={`${manrope.className} mb-8 text-base leading-relaxed text-reviuy-gray-600 dark:text-reviuy-gray-400 md:text-lg`}
                >
                  Implementamos las mejores practicas de seguridad para proteger tu identidad y
                  datos personales, cumpliendo con la Ley N 18.331 de Proteccion de Datos
                  Personales.
                </p>
                ...
                >
                  {privacyFeatures.map((feature) => (
                    ...
                    >
                      ...
                      <div>
                        <h3
                          className={`${manrope.className} text-base font-semibold text-reviuy-gray-900 dark:text-white`}
                        >
                          {feature.title}
                        </h3>
                        <p
                          className={`${manrope.className} mt-1 text-sm text-reviuy-gray-600 dark:text-reviuy-gray-400`}
                        >
                          {feature.description}
                        </p>
                      </div>
