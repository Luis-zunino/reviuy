      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-reviuy-gray-200/60 dark:border-reviuy-gray-700/50 bg-white dark:bg-reviuy-gray-800/50 p-8 shadow-sm md:p-12 lg:p-16">
          ...
          >
            ...
            <p className={`${manrope.className} mt-4 text-lg leading-relaxed text-reviuy-gray-600 dark:text-reviuy-gray-400`}>
          ...
          >
            {features.map((feature) => (
              ...
              >
                ...
                <h3 className={`${manrope.className} mb-3 text-lg font-bold text-reviuy-gray-900 dark:text-white`}>
                  {feature.title}
                </h3>
