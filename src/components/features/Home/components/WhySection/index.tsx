...
const features = [
  {
    ...
    borderColor: 'border-reviuy-primary-100',
  },
  {
    icon: Star,
    title: 'Evalua antes de alquilar',
    description: 'Entende el estado del inmueble, el trato del propietario y el contexto del barrio.',
    color: 'text-reviuy-success-600',
    bgColor: 'bg-reviuy-success-50',
    borderColor: 'border-reviuy-success-100',
  },
  {
    icon: Users,
    title: 'Comparti y protege',
    description: 'Tu resena ayuda a toda la comunidad a tomar decisiones mas seguras.',
    color: 'text-reviuy-secondary-600',
    bgColor: 'bg-reviuy-secondary-50',
    borderColor: 'border-reviuy-secondary-100',
  },
];
  ...
  return (
    <section className="py-16 md:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-reviuy-gray-200/60 bg-white p-8 shadow-sm md:p-12 lg:p-16">
          {/* Header */}
          <motion.div
          ...
          >
            ...
            <p className={`${manrope.className} mt-4 text-lg leading-relaxed text-reviuy-gray-600`}>
              Tomamos resenas reales y las convertimos en una decision clara para tu proximo alquiler.
            </p>
          </motion.div>
          ...
          >
            {features.map((feature) => (
              ...
              >
                ...
                <h3 className={`${manrope.className} mb-3 text-lg font-bold text-reviuy-gray-900`}>
                  {feature.title}
                </h3>
          ...
          >
            <Link
              ...
              className={cn(
                manrope.className,
                'group inline-flex items-center gap-2 rounded-xl bg-reviuy-primary-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-reviuy-primary-700 hover:shadow-md'
              )}
            >
