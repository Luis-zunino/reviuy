...
export const Logo = () => {
  return (
    ...
    >
      <div className="absolute left-2 top-4 bottom-4 w-8 h-8 bg-linear-to-br p-4 from-blue-600 to-blue-600 rounded-lg transition-all duration-400 ease-out group-hover:w-[calc(100%-1rem)] group-hover:h-8 group-hover:rounded-lg z-0" />
