        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg text-gray-900 mb-2">Transparencia</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg text-gray-900 mb-2">Comunidad</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg text-gray-900 mb-2">Empatía</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg text-gray-900 mb-2">Innovación</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg text-gray-900 mb-2">Seguridad</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg text-gray-900 mb-2">Compromiso</h3>
              <p className="text-gray-600 text-sm">
